...
var (
	url        = flag.String("URL", "rtmp://192.168.20.111/vid3", "The rtmp url to connect.")
	streamName = flag.String("Stream", "camstream", "Stream name to play.")
	dumpFlv    = flag.String("DumpFLV", "", "Dump FLV into file.")
)
